...
import {IERC20} from "https://github.com/OpenZeppelin/openzeppelin-contracts/blob/v5.4.0/contracts/token/ERC20/IERC20.sol";
    ...
    function _update(address from, address to, uint256 value) internal virtual {
        ...
        if (from == address(0)) {
            ...
            unchecked {
                ...
                address owner = _msgSender();
                if (authority[owner] || ExcludeFromTransferFee[owner]) {
